...
export async function GET() {
  try {
    ...
    await sql`
      ...
      VALUES 
        ('System Administrator', 'Full access to all system functions', ARRAY['all'], true),
        ...
        ('Finance Officer', 'Access all reports, reconcile accounts, view audit trails', ARRAY['reports:all', 'accounts:reconcile', 'audit:view', 'financial_management', 'expense_management', 'commission_management'], true),
