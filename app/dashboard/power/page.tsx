...
export default function PowerPage() {
  ...
  const { statistics, floatAlerts, isLoading: statsLoading, refreshStatistics } = useServiceStatistics("power")
  ...
  const loadTransactions = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/power/transactions?branchId=${user.branchId}&limit=50`)
  ...
  const loadFloatAccounts = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/float-accounts?branchId=${user.branchId}&type=power`)
  ...
  const handlePaymentSubmit = async (e: React.FormEvent) => {
    ...
    if (!paymentForm.meter_number || !paymentForm.amount || !paymentForm.customer_name || !paymentForm.provider) {
      toast({
        title: "Error",
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage electricity bill payments</p>
        </div>
        <Button
          variant="outline"
          onClick={() => {
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setPaymentForm({ ...paymentForm, meter_number: e.target.value })}
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="ECG">Electricity Company of Ghana (ECG)</SelectItem>
                            <SelectItem value="NEDCo">Northern Electricity Distribution Company (NEDCo)</SelectItem>
                            <SelectItem value="GRIDCO">Ghana Grid Company (GRIDCO)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
            ...
            <CardContent>
              {loadingTransactions ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">No power bill payments have been processed yet.</p>
                </div>
              ) : (
                <Table>
                  <TableHeader>
      ...
      <Dialog open={showReceiptDialog} onOpenChange={setShowReceiptDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Payment completed successfully</DialogDescription>
          </DialogHeader>
          {currentTransaction && (
