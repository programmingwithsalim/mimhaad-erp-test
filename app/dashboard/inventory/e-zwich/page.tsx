    ...
    <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage card batches and track inventory levels
            </p>
          </div>
        </div>
          ...
          <Dialog open={addStockOpen} onOpenChange={setAddStockOpen}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Add a new batch of E-Zwich cards to inventory
                </DialogDescription>
              </DialogHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage and track all card batches
            {user?.role === "Admin" &&
              selectedBranch &&
              selectedBranch !== "all" && (
                <span className="ml-2 text-blue-600">
      ...
      <Dialog open={editStockOpen} onOpenChange={setEditStockOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Update the details of the selected card batch
            </DialogDescription>
          </DialogHeader>
          {selectedBatch && (
            <EZwichEditBatchForm
