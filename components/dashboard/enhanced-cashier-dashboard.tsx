    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Process transactions and manage customer interactions
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your latest processed transactions</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {totalStats.floatAlerts && totalStats.floatAlerts.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Accounts with low balance - contact supervisor
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Cashier Tools</CardTitle>
          <CardDescription>Useful tools for daily operations</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <Link href="/dashboard/float-management">
              <Button variant="outline" className="w-full h-16 flex-col">
                <Wallet className="h-5 w-5 mb-1" />
                <span className="text-xs">Float Status</span>
              </Button>
            </Link>
