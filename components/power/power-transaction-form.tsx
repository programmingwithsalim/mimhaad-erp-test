...
export function PowerTransactionForm({ powerFloats, onSubmit, onSuccess }: PowerTransactionFormProps) {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Process electricity bill payments and prepaid top-ups</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            ...
            {selectedPowerAccount && (
              <div className="mt-2 p-3 bg-blue-50 rounded text-sm">
                <p>
                  <strong>Selected Provider:</strong> {selectedPowerAccount.provider}
                </p>
                <p>
                  <strong>Available Balance:</strong> {formatCurrency(selectedPowerAccount.current_balance)}
                </p>
                <p>
                  <strong>Account Type:</strong> {selectedPowerAccount.account_type}
                </p>
              </div>
            )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Brief description of the transaction" className="resize-none" {...field} />
                  </FormControl>
                  <FormDescription>Describe the purpose of this transaction.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
