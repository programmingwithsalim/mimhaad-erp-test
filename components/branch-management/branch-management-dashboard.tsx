...
import { PlusCircle, DownloadCloud, Search, RefreshCw, Loader2, AlertCircle } from "lucide-react"
...
export function BranchManagementDashboard() {
  ...
  const [realStatistics, setRealStatistics] = useState<BranchStatistics | null>(null)
  ...
  const filteredBranches =
    activeTab === "all-branches" ? safeBranches : safeBranches.filter((branch) => branch.status === activeTab)
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          <Dialog open={openAddDialog} onOpenChange={setOpenAddDialog}>
            <Button className="hidden sm:flex" onClick={() => setOpenAddDialog(true)}>
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>Fill in the details to add a new branch to your network.</DialogDescription>
              </DialogHeader>
              <CreateBranchForm onSubmit={handleAddBranch} onCancel={() => setOpenAddDialog(false)} />
            </DialogContent>
          </Dialog>
          <Button variant="outline" className="hidden sm:flex" onClick={handleRefresh}>
          ...
          <Button variant="ghost" size="icon" className="sm:hidden" onClick={() => setOpenAddDialog(true)}>
            <PlusCircle className="h-5 w-5" />
          </Button>
          <Button variant="ghost" size="icon" className="sm:hidden" onClick={handleRefresh}>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {realStatistics?.activeBranches || 0} active, {realStatistics?.inactiveBranches || 0} inactive
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {statsLoading ? <Loader2 className="h-6 w-6 animate-spin" /> : realStatistics?.totalStaff || 0}
            </div>
            <p className="text-xs text-muted-foreground">
              Avg {realStatistics?.averageStaffPerBranch?.toFixed(1) || 0} per branch
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {statsLoading ? <Loader2 className="h-6 w-6 animate-spin" /> : realStatistics?.totalManagers || 0}
            </div>
            <p className="text-xs text-muted-foreground">Unique managers assigned</p>
          </CardContent>
        </Card>
      ...
      {realStatistics?.regionalDistribution && realStatistics.regionalDistribution.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>Regional Distribution</CardTitle>
            <CardDescription>Branches and staff distribution across regions</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Tabs defaultValue="all-branches" value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
        ...
        <TabsContent value="all-branches">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Manage your branch network from this central dashboard.</CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
        ...
        <TabsContent value="active">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>All currently operational branches in your network.</CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
                <div className="flex justify-center items-center h-64">
                ...
                <div className="flex flex-col justify-center items-center h-64 text-center">
                  <p className="text-muted-foreground mb-4">No active branches found</p>
                  <Button onClick={() => setOpenAddDialog(true)}>
                    <PlusCircle className="mr-2 h-4 w-4" />
                    Add Branch
                  </Button>
        ...
        <TabsContent value="inactive">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Temporarily closed or non-operational branches.</CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
                <div className="flex justify-center items-center h-64">
                ...
                <div className="flex flex-col justify-center items-center h-64 text-center">
                  <p className="text-muted-foreground mb-4">No inactive branches found</p>
                  <Button onClick={() => setOpenAddDialog(true)}>
                    <PlusCircle className="mr-2 h-4 w-4" />
                    Add Branch
                  </Button>
      ...
      <Sheet open={openDetailsSheet} onOpenChange={setOpenDetailsSheet}>
        <SheetContent className="sm:max-w-[600px] overflow-y-auto">
          <SheetHeader>
            ...
            <SheetDescription>Detailed information about the branch.</SheetDescription>
          </SheetHeader>
          {selectedBranch && (
            <div className="mt-6">
