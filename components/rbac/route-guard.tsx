...
const routePermissions: Record<string, string[]> = {
  ...
  "/dashboard/transactions/all": ["admin", "manager", "finance", "operations", "cashier"],
  "/dashboard/momo": ["admin", "manager", "finance", "operations"],
  "/dashboard/agency-banking": ["admin", "manager", "finance", "operations"],
  "/dashboard/e-zwich": ["admin", "manager", "finance", "operations"],
  "/dashboard/power": ["admin", "manager", "finance", "operations"],
  "/dashboard/jumia": ["admin", "manager", "finance", "operations"],
  "/dashboard/transactions/reversals": ["admin", "manager", "finance"],
  "/dashboard/float-management": ["admin", "manager", "finance"],
  "/dashboard/expenses": ["admin", "manager", "finance"],
  ...
  "/dashboard/settings": ["admin", "manager", "finance", "operations", "cashier"],
}
      ...
      <div className="flex items-center justify-center min-h-[400px] p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              You don't have permission to access this page. Your current role ({user?.role}) doesn't allow access to
              this resource.
            </CardDescription>
          </CardHeader>
