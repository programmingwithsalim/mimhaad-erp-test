  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const statementResponse = await fetch(
        `/api/float-accounts/comprehensive-statement?floatAccountId=${floatAccountId}&startDate=${startDate}&endDate=${endDate}`
      );
      ...
      const summaryResponse = await fetch(
        `/api/float-accounts/enhanced-summary?floatAccountId=${floatAccountId}&startDate=${startDate}&endDate=${endDate}`
      );
