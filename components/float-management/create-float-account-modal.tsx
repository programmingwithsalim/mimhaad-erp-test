...
export function CreateFloatAccountModal({
  ...
  const getProviderPlaceholder = (accountType: string) => {
    switch (accountType) {
      case "momo":
        return "e.g., MTN, Vodafone, AirtelTigo";
      case "agency-banking":
        return "e.g., Ecobank, GCB, Fidelity";
      case "power":
        return "e.g., ECG, NEDCo, VRA";
      case "jumia":
        return "e.g., Jumia Ghana";
      case "e-zwich":
        return "e.g., Ghana Interbank";
      default:
        return "e.g., Provider name";
    }
  };
