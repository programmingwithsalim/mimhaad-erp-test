...
export function UserManagementDashboard() {
  ...
  const { branches, loading: isLoadingBranches, error: branchError } = useBranches()
  ...
  useEffect(() => {
    if (branchError) {
      console.warn("Branch loading error (non-critical):", branchError)
    }
  }, [branchError])
  ...
  const handleFormSubmit = async (userData: any) => {
    try {
      ...
      toast({
        title: "Success",
        description: result.message || `User ${selectedUser ? "updated" : "created"} successfully`,
      })
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">{selectedUser ? "Edit User" : "Add New User"}</h1>
    ...
    <div className="space-y-6">
      ...
      {branchError && (
        <Alert className="mb-4">
          ...
          <AlertDescription>
            Warning: Branch data could not be loaded. Some features may be limited.
              ...
              <TableBody>
                {filteredUsers.map((user) => (
                  <TableRow key={user.id}>
                    ...
                    <TableCell>
                      <div className="text-sm">{user.primaryBranchName || "No branch"}</div>
                    </TableCell>
                      ...
                      <div className="flex justify-end gap-1">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => handleResetPassword(user)} disabled={isSubmitting}>
