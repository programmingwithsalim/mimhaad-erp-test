// Test script for E-Zwich statistics fix
// Run this in the browser console

async function testEzwichStatistics() {
  ...
  try {
    ...
    const ezwichResponse = await fetch(
      "/api/e-zwich/statistics?branchId=86d0097e-9bce-4f1f-b9b4-9dd2dc9ee01c"
    );
    ...
    if (ezwichResponse.ok && ezwichResult.success) {
      ...
      if (hasData) {
        ...
        console.log("⚠️  WARNING: All E-Zwich statistics are showing 0.00");
        console.log(
    ...
    console.log("🎉 E-Zwich statistics test completed!");
  } catch (error) {
